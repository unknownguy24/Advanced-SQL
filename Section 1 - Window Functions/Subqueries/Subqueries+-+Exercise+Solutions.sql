...
-- from the Purchasing.PurchaseOrderHeader table. There should ONLY be three records per Vendor ID, 
-- even if some of the total amounts due are identical. "Most expensive" is defined by the amount in the "TotalDue" field.
...
-- Ultimately, you should see three distinct total due amounts (i.e., the top three) 
-- for each group of like Vendor Ids. However, there could be multiple records for each of these amounts.
